...
function geolocationErrorMessage(err) {
  if (err.code === 1) {
    if (isStandalonePwa()) {
      return 'Standortzugriff verweigert. iOS: Einstellungen → Datenschutz & Sicherheit → Ortungsdienste → Systemdienste → «In-App-Browsing» aktivieren → App Neustart. Android: App-Info → Berechtigungen → Standort.';
    }
